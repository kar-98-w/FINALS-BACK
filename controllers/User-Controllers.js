...
module.exports.updatePassword = (req, res) => {
    const { id } = req.user;  // Get user ID from token (middleware should have authenticated the user)
    ...
    return User.findById(id).then(user => {
        ...
        const isCurrentPasswordCorrect = bcryptjs.compareSync(currentPassword, user.password);
